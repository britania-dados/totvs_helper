...
from totvs_helper.paths import pentaho_templates_dir
...
from totvs_helper.services.pentaho.layout import (
...
class PentahoExporter:
    ...
    def __init__(
        ...
        *,
        ...
        self._template_root = template_root or pentaho_templates_dir()
